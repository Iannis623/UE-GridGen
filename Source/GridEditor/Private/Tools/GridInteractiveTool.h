...
#include "GridInteractiveTool.generated.h"


/**
 * Builder for UGridInteractiveTool
 */
UCLASS()
class GRIDEDITOR_API UGridInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UGridInteractiveTool
 */
UCLASS(Transient)
class GRIDEDITOR_API UGridInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UGridInteractiveToolProperties();
...
/**
 * UGridInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class GRIDEDITOR_API UGridInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UGridInteractiveToolProperties> Properties;


protected:
	TObjectPtr<UWorld> TargetWorld = nullptr;		// target World we will raycast into
