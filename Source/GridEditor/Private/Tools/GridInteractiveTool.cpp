...
#define LOCTEXT_NAMESPACE "UGridInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UGridInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UGridInteractiveTool* NewTool = NewObject<UGridInteractiveTool>(SceneState.ToolManager);
...
UGridInteractiveToolProperties::UGridInteractiveToolProperties()
{
...
void UGridInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UGridInteractiveTool::Setup()
{
	...
	Properties = NewObject<UGridInteractiveToolProperties>(this, "Measurement");
...
void UGridInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UGridInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UGridInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UGridInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UGridInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UGridInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UGridInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UGridInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UGridInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
